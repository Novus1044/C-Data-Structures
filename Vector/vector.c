...
// It can be overwritten, but that is not guaranteed, that is why as we go through the entire capacity of the Vector we need to check
// whether the element is NULL and has therefore been previously freed.
static void
